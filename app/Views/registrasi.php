		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action=" <?= base_url(); ?>" method="POST" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="text" name="notlp" placeholder="No.telpon Sekolah">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fas fa-location" aria-hidden="true"></i>
						</span>
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="text" name="email" placeholder="Email Sekolah">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fas fa-location" aria-hidden="true"></i>
						</span>
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="text" name="pass" placeholder="Re-type New Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fas fa-location" aria-hidden="true"></i>
						</span>
